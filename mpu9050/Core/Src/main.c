...
extern float asax,asay,asaz;
extern float mag_offset[3] ;
extern float Accel_X,Accel_Y,Accel_Z,Gyro_X,Gyro_Y,Gyro_Z;
extern float Mag_X_calib,Mag_Y_calib,Mag_Z_calib;
extern int32_t mag_bias[3] , mag_scale[3];
extern float scale_x ,scale_y,scale_z;
